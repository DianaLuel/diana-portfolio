...
type ProjectScreenshot = { src: string; alt: string; isMobile: boolean };

function createScreenshots(folder: string, entries: Array<[string, string, boolean]>): ProjectScreenshot[] {
  return entries.map(([filename, alt, isMobile]) => ({
...
const projectScreenshots: Record<string, ProjectScreenshot[]> = {
  ...
  ercs: createScreenshots("ERCS", [
    ["Land.png", "ERCS landing page", false], ["Landinf Page.png", "ERCS landing information", false], ["Humaniterian.png", "ERCS humanitarian page", false], ["News.png", "ERCS news", false], ["PR1.png", "ERCS public relations", false], ["Train.png", "ERCS training", false], ["Admin Dashboard.png", "ERCS admin dashboard", false], ["Manage members.png", "ERCS member management", false], ["memberRegister.png", "ERCS member registration", false], ["Reg mem 1.png", "ERCS registration", false], ["Reg mem 2.png", "ERCS registration details", false], ["Reg mem 3.png", "ERCS registration confirmation", false], ["view member.png", "ERCS member profile", false], ["Volenteer Hub.png", "ERCS volunteer hub", false], ["Volenteer Register.png", "ERCS volunteer registration", false], ["Volenteer Register-1.png", "ERCS volunteer registration details", false], ["volunteer-dashboard.png", "ERCS volunteer dashboard", false], ["volunteer-noti.png", "ERCS volunteer notifications", false], ["vol- ID 1.png", "ERCS volunteer ID", false], ["vol- ID 2.png", "ERCS volunteer ID details", false], ["Blood D.png", "ERCS blood donation", false], ["Chat.png", "ERCS chat", false], ["Events mob.png", "ERCS mobile events", true], ["Explore mob.png", "ERCS mobile explore", true],
  ]),
